...
trim_df = function(dff) {
  ...
  trim = remove_first_minute(group_df_by_1_minute(trim))
  return(trim)
}
...
root_path_0 = "/local/storm/experimentos/throughput1/0"
analysis_table = create_frame(root_path_0, list_messages,"ind")
root_path_1 = "/local/storm/experimentos/throughput1/0"
analysis_table = create_frame(root_path_1, list_messages,"ind")
root_path_2 = "/local/storm/experimentos/throughput1/0"
analysis_table = create_frame(root_path_2, list_messages,"ind")
root_path_3 = "/local/storm/experimentos/throughput1/0"
analysis_table = create_frame(root_path_3, list_messages,"ind")
