...
list_messages = c(420, 1260, 2100, 4200, 8400, 16800, 25200, 33600)

create_data_list = function(run) {
  data_420 = metrics(paste(root_path,420, run ,sep="/"), ";")
  data_1260 = metrics(paste(root_path,1260, run ,sep="/"), ";")
  data_2100 = metrics(paste(root_path,2100, run ,sep="/"), ";")
  data_4200 = metrics(paste(root_path,4200, run ,sep="/"), ";")
  data_8400 = metrics(paste(root_path,8400, run ,sep="/"), ";")
  data_16800 = metrics(paste(root_path,16800, run ,sep="/"), ";")
  data_25200 = metrics(paste(root_path,25200, run ,sep="/"), ";")
  data_33600 = metrics(paste(root_path,33600, run ,sep="/"), ";")  
  
  list_data = list(data_420, data_1260, data_2100, data_4200, data_8400, data_16800, data_25200, data_33600)
  return(list_data)
}
...
run = function(type) {
  ...
  list_data_420 = create_data_list_by_input_rate(420)
  list_data_1260 = create_data_list_by_input_rate(1260)
  list_data_2100 = create_data_list_by_input_rate(2100)
  list_data_4200 = create_data_list_by_input_rate(4200)
  list_data_8400 = create_data_list_by_input_rate(8400)
  list_data_16800 = create_data_list_by_input_rate(16800)
  list_data_25200 = create_data_list_by_input_rate(25200)
  list_data_33600 = create_data_list_by_input_rate(33600)
